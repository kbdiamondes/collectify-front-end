            ...
            <View style={styles.main}>
                ...
                <View style={styles2.miniButtonContainer}>
                    <View style={styles2.miniButtonWrapper}>
                        <Pressable onPress={() => {navigation.navigate('CollectorTabNavigator', {screen: 'Collection'})}} style={styles2.miniButtonPressable}>
                        <View style={styles2.miniButton}>
                            <Ionicons name="clipboard" color="#444DD8" size={hp(4)} />
                        </View>
                        <Text style={styles2.textLabelStyle}>Collect</Text>
                        </Pressable>
                    </View>

                    <View style={styles2.miniButtonWrapper}>
                    <Pressable onPress={()=>( navigation.navigate('CollectorTabNavigator', { screen: 'Follow Up' }))} style={styles2.miniButtonPressable}>   
                        <View style={styles2.scheduleMiniButton}>
                            <Ionicons name="chatbox" color="#DBC678"  size={hp(4)}/>
                        </View>
                        <Text style={styles2.scheduletextLabelStyle}>Follow Up</Text>
                        </Pressable>
                    </View>

                    <View style={styles2.miniButtonWrapper}>
                        <Pressable onPress={() => (navigation.navigate('CollectorTabNavigator', {screen: 'Assurance'}))} style={styles2.miniButtonPressable}>
                        <View style={styles2.reminderMiniButton}>
                        <Ionicons name="shield" color="#965E65"  size={hp(4)}/>
                        </View>
                        <Text style={styles2.remindertextLabelStyle}>Assurance</Text>
                        </Pressable>
                    </View>

                    <View style={styles2.miniButtonWrapper}>
                        <Pressable onPress={() => (navigation.navigate('CollectorTabNavigator', { screen: 'Record' }))} style={styles2.miniButtonPressable}>
                        <View style={styles2.miniButton}>
                            <Ionicons name="card" color="#444DD8"  size={hp(4)}/>
                        </View>
                        <Text style={styles2.textLabelStyle}>Record</Text>
                        </Pressable>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent: 'space-between'}}>
                        ...
                        <View style={{marginTop: hp(2), marginBottom: hp(2),  alignItems:'flex-start'}}>
                            <Text style={{fontSize: hp(2)}}> Recent Collections</Text>
                        </View>                
