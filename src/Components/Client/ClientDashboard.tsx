            ...
            <View style={styles.main}>
                ...
                <View style={styles2.miniButtonContainer}>
                    <View style={styles2.miniButtonWrapper}>
                        ...
                        <Text style={styles2.textLabelStyle}>Dues</Text>
                        </Pressable>
                    </View>
                    ...
                    <Pressable onPress={()=>( navigation.navigate('ClientDashboardTabNavigator', { screen: 'Schedule' }))} style={styles2.miniButtonPressable}>   
                        ...
                        <Text style={styles2.scheduletextLabelStyle}>Schedules</Text>
                        </Pressable>
                    </View>
                    ...
                    <View style={styles2.miniButtonWrapper}>
                        ...
                        <Text style={styles2.remindertextLabelStyle}>Reminders</Text>
                        </Pressable>
                    </View>
                    ...
                    <View style={styles2.miniButtonWrapper}>
                        ...
                        <Text style={styles2.textLabelStyle}>History</Text>
                        </Pressable>
                    </View>
                    ...
                    <View style={styles2.miniButtonWrapper}>
                        ...
                        <Text style={styles2.textLabelStyle}>Records</Text>
                        </Pressable>
                    </View>
